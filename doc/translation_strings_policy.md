...
This document provides guidelines for internationalization of the Sucrecoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `sucrecoin_en.ts` remains unchanged.
