...
class TxnMallTest(SucrecoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 XSR:
        ...
        # First: use raw transaction API to send 1240 XSR to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 XSR coin each
        ...
        # Node0's balance should be starting balance, plus 50XSR for another
        ...
        # Node0's total balance should be starting balance, plus 100XSR for 
