...
class BIP66Test(SucrecoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # sucrecoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and sucrecoind produces more specific reject
            # reasons.
