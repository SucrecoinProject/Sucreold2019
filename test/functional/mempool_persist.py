...
By default, sucrecoind will dump mempool on shutdown and
...
class MempoolPersistTest(SucrecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give sucrecoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent sucrecoind from writing mempool.dat to disk. Verify that `savemempool` fails")
