...
# TestNode: A peer we use to send messages to sucrecoind, and store responses.
...
class CompactBlocksTest(SucrecoinTestFramework):
    ...
    # This test actually causes sucrecoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that sucrecoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for sucrecoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # sucrecoind will not send blocktxn responses for blocks whose height is
