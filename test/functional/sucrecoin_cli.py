...
class TestSucrecoinCli(SucrecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from `sucrecoin-cli -getinfo` and the RPCs data is retrieved from.")
