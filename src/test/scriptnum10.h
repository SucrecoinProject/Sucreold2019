...
#ifndef SUCRECOIN_TEST_SCRIPTNUM10_H
#define SUCRECOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Sucrecoin Core 0.10.0, for cross-comparison.
 */
public:
