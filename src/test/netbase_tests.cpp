...
{
    BOOST_CHECK(TestSplitHost("www.sucrecoin.org", "www.sucrecoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.sucrecoin.org]", "www.sucrecoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.sucrecoin.org:80", "www.sucrecoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.sucrecoin.org]:80", "www.sucrecoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:2108", "127.0.0.1", 2108));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:2108", "127.0.0.1", 2108));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:2108", "::ffff:127.0.0.1", 2108));
    BOOST_CHECK(TestSplitHost("[::]:2108", "::", 2108));
    BOOST_CHECK(TestSplitHost("::2108", "::2108", -1));
    BOOST_CHECK(TestSplitHost(":2108", "", 2108));
    BOOST_CHECK(TestSplitHost("[]:2108", "", 2108));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:2108", "127.0.0.1:2108"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:2108", "[::]:2108"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
