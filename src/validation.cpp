...
const std::string strMessageMagic = "Sucrecoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s XSR additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("sucrecoin-scriptch");
