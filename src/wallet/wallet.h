...
#ifndef SUCRECOIN_WALLET_WALLET_H
#define SUCRECOIN_WALLET_WALLET_H
...
public:
     ...
     * on this sucrecoin node, and set to 0 for transactions that were created
...
#endif // SUCRECOIN_WALLET_WALLET_H
