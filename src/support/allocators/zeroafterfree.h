...
#ifndef SUCRECOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define SUCRECOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // SUCRECOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
