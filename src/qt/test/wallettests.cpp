...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<SucrecoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_sucrecoin-qt -platform xcb      # Linux
//     src/qt/test/test_sucrecoin-qt -platform windows  # Windows
//     src/qt/test/test_sucrecoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = SucrecoinUnits::formatWithUnit(unit, balance, false, SucrecoinUnits::separatorAlways);
    ...
    // Amount input
    SucrecoinAmountField* amountInput = receiveCoinsDialog.findChild<SucrecoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: sucrecoin:")) != -1);
