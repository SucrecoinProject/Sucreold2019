...
#ifndef SUCRECOIN_QT_SUCRECOINUNITS_H
#define SUCRECOIN_QT_SUCRECOINUNITS_H
...
/** Sucrecoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SucrecoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SucrecoinUnits(QObject *parent);

    /** Sucrecoin units.
      @note Source: https://en.sucrecoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        XSR,
...
typedef SucrecoinUnits::Unit SucrecoinUnit;

#endif // SUCRECOIN_QT_SUCRECOINUNITS_H
