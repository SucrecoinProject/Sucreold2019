...
public:
    ...
    QPushButton *openSucrecoinConfButton;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        sucrecoinAtStartup = new QCheckBox(tabMain);
        sucrecoinAtStartup->setObjectName(QStringLiteral("sucrecoinAtStartup"));

        verticalLayout_Main->addWidget(sucrecoinAtStartup);
        ...
        openSucrecoinConfButton = new QPushButton(OptionsDialog);
        openSucrecoinConfButton->setObjectName(QStringLiteral("openSucrecoinConfButton"));
        openSucrecoinConfButton->setAutoDefault(false);

        verticalLayout_Buttons->addWidget(openSucrecoinConfButton);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        sucrecoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start %1 after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        sucrecoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start %1 on system login", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Sucrecoin client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Sucrecoin network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocksTor->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Sucrecoin network through a separate SOCKS5 proxy for Tor hidden services.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        openSucrecoinConfButton->setToolTip(QApplication::translate("OptionsDialog", "Open the %1 configuration file from the working directory.", 0));
#endif // QT_NO_TOOLTIP
        openSucrecoinConfButton->setText(QApplication::translate("OptionsDialog", "Open Configuration File", 0));
#ifndef QT_NO_TOOLTIP
