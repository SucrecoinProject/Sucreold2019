/* src/config/sucrecoin-config.h.  Generated from sucrecoin-config.h.in by configure.  */
/* src/config/sucrecoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef SUCRECOIN_CONFIG_H

#define SUCRECOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Sucrecoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Sucrecoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/SucrecoinProject/Sucrecoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Sucrecoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Sucrecoin Core 0.17.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "sucrecoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://sucrecoin.org/"
